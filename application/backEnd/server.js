...
const database = mysql.createConnection({
  host: "database-1.cdx4yqkogktl.us-west-2.rds.amazonaws.com",
  port: 3306,
  user: "admin",
  password: "Team06SFSU!",
  database: "Main",
        ...
        if (result.length === 0) {
          ...
          bcrypt.genSalt(10, (err, salt) => {
            bcrypt.hash(password, salt, function (err, hash) {
              ...
              const insertQuery = 'INSERT INTO Account (username, email, password, secAnswer, account_type) VALUES (?, ?, ?, ?, ?)';
              const insertParams = [formattedUsername, email, hash, secAnswer, account_type];
